...
namespace Vidly.Controllers
{
    public class MoviesController : Controller
    {
        ...
        //[HttpPost]
        // public ActionResult Create(NewMovieViewModel viewModel)   << by doing this (NewMovieViewModel viewModel) it will automatically bind (model bind) the result/type to the view model
